...
function CommunityVacancy() {
  ...
  useEffect(() => {
    ...
    mapboxgl.accessToken = "pk.eyJ1Ijoia2FhamJvbGFuZCIsImEiOiJjbG5kejg0emIwOGRyMmxsZW9vaXYyMGswIn0.Rhnj7A5aOZh0JBebF4WaFQ";

    fetch("https://home-sphere.ca/api/maps/community_vacancy", {
      headers: {
  ...
  }, [mapData]); // Ensure useEffect runs when mapData changes
